# 📝 TodoGravita - 现代化待办事项管理系统

[![FastAPI](https://img.shields.io/badge/FastAPI-005571?style=for-the-badge&logo=fastapi)](https://fastapi.tiangolo.com/)
[![React](https://img.shields.io/badge/React-20232A?style=for-the-badge&logo=react&logoColor=61DAFB)](https://reactjs.org/)
[![TypeScript](https://img.shields.io/badge/TypeScript-007ACC?style=for-the-badge&logo=typescript&logoColor=white)](https://www.typescriptlang.org/)
[![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://www.python.org/)
[![GitHub](https://img.shields.io/badge/GitHub-Repository-black?style=for-the-badge&logo=github)](https://github.com/Soleil1043/TodoGravita)

## 📋 版本信息

- **当前版本**: v2.3.0
- **后端服务**: FastAPI v0.100+
- **前端应用**: React 18 + Vite 5
- **监控系统**: Sentry 实时监控
- **数据库**: SQLite 3

一个功能完整的现代化待办事项管理应用，采用前后端分离架构，支持完整的CRUD操作、回收站管理、优先级分类、时间规划、多视图切换及个性化设置功能。
...
- ✅ 时间规划（开始/结束时间）
- ✅ 完成状态切换
- ✅ 多视图切换：Dashboard、Matrix、Quadrant
- ✅ 四象限可视化交互视图
...
- ✅ **外观设置**: 支持自定义壁纸上传和主题颜色切换
- ✅ **Sentry 监控**: 前端错误自动捕获和性能分析
- ✅ **响应式布局**: 完美适配移动端和超宽屏
...
interface TodoSchema {
  ...
  future_score?: number;          // 未来价值评分 (-3 到 3)
  urgency_score?: number;         // 紧急程度评分 (-3 到 3)
  final_priority: number;         // 最终优先级分数（自动计算）
...
#### 后端使用 SQLAlchemy ORM，包含以下字段

##### todo_items 表（TodoORM）
...
##### recycle_bin_items 表（RecycleBinORM）
...
2. **跨域处理**: 前端已配置代理，无需额外 CORS 设置
3. **数据持久化**: 使用 SQLite 数据库，数据自动持久化存储
...
[📂 项目仓库](https://github.com/yourusername/todo-management) • [🐛 报告问题](https://github.com/yourusername/todo-management/issues) • [🔀 提交 PR](https://github.com/yourusername/todo-management/pulls)
